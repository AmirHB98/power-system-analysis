...
def generate_power_system_positions(
    ps, layout_type="spectral", geographic_data=None, seed=42
):
    """
...
def get_system_positions(
    ps, system_name=None, layout_type="spectral", geographic_data=None, seed=42
):
    """
    ...
    elif system_name == "26-bus" and ps.nbus == 26:
        # Predefined positions for IEEE 14-bus system
        positions = {
            1: (2, 0),
            2: (3, 0),
    ...
    return generate_power_system_positions(
        ps, layout_type=layout_type, geographic_data=geographic_data, seed=seed
    )

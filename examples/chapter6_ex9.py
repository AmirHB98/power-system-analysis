...
# Plot both results
plot_power_system(ps, node_positions=pos, ax=ax1, 
                 title="IEEE 30-Bus System (Gauss-Seidel)")
plot_power_system(ps_newton, node_positions=pos, ax=ax2, 
                 title="IEEE 30-Bus System (Newton-Raphson)")
